...
def insert_custom_activities(apps, _):
    DayOfWeek = apps.get_model('polls', 'DayOfWeek')
    TimeSlot = apps.get_model('polls', 'TimeSlot')
    DailyActivity = apps.get_model('polls', 'DailyActivity')
